...
from gui.widgets.codescrollview import CodeScrollView, CodeContainer
from gui.widgets.codescrollview import CodeListItem
...
class BlameCodeScrollView(CodeScrollView, EventWidget):
    ...
    def _insert_line(self, **kwargs):
        super(BlameCodeScrollView, self)._insert_line(
            callback=self.handle_selection_change, index=self.line_index,
            **kwargs)
        self.line_index += 1
